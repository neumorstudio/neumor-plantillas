# NeumorStudio Template: Clinic (Astro 5 SSR)

Plantilla publica para clinicas. Render SSR con Astro, configuracion desde Supabase y formulario de citas via API del admin.
...
- `src/components/`: secciones y variantes (Hero, Treatments, Features, Footer, `AppointmentForm.astro`).
...
- `pnpm dev:clinic`
- `pnpm dev --filter @neumorstudio/template-clinic`
